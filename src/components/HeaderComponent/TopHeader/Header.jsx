...
import { FaRegEnvelope, FaFacebookF, FaInstagram, FaTwitter } from "react-icons/fa";
            ...
            <Row style={{borderBottom:"1px solid rgba(255, 255, 255, 0.49)"}}>
               ...
               <Container>
                    <div className="text-white header-info">
                        <p>
                            < FaRegEnvelope /> <span> Email:<a href="/" className="text-white">info@eat-berlin.de</a></span>
                        </p>
                        <p>
                            < FiPhoneCall /> <span> Telephone: +49 176 810 18609</span>
                        </p>
                    </div>
