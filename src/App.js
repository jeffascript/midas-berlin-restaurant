...
import IntroAnimation from "./components/InitLoader/IntroAnimation";
        ...
        <>
          ...
          <div className="w-100 h-100" style={{ overflowX: "hidden" }}>
            <div id="home">
              <Container
                fluid
                className="main-bg position-relative  p-0 after-main"
              >
                <header>
                  <div
            ...
            <section id="offer" className="section-outline">
              <Container
                fluid
                className="bg-dark section-dark-cover "
                style={bgImg}
              >
                <Row>
                  <Offers />
            ...
            <section id="info" className="section-team section-outline ">
              <Container
                fluid
                className="bg-white section-dark-cover  "
                style={infoBg}
              >
                <Row>
                  <Information />
            ...
            <section id="contact" className="section-team footer-section ">
              <Container
                fluid
                className="bg-white footer-dark-cover  "
                style={contactBgImg}
              >
                <Row>
                  <Contact />
